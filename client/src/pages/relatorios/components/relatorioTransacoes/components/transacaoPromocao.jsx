...
import { transacaoPromocaoTableSchema } from 'common/table/schemas/transacaoPromocao'

const TransacaoPromocao = () => {
  ...
  return (
    <div>
      <Table apiRoute={callPromocaoAPI.todos} editColumn={true} unidade={false} resizeContainer={true} setCurrentState={{funcs: setSelectedItems}} columnSchema={transacaoPromocaoTableSchema} rowCount={5} subcategoria={false} area={false} ativo={false}/>
...
export default TransacaoPromocao