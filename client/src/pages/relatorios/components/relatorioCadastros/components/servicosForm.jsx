...
import { yupSchemaCadServico } from 'utils/validation/schemas/relatorios/yupSchemaCadServico'
      ...
      <div style={{height: '42vh'}}>
        ...
        <div className='row'>
          <div className="mb-3 col-6">
            <QuestionTooltip label='Data inicial' msg='Define a data inicial do período em que o relatório ira buscar pelos serviços.' />
          ...
          <div className="mb-3 col-6">
            <QuestionTooltip label='Data final' msg='Define a data final do período em que o relatório ira buscar pelos serviços.' />
